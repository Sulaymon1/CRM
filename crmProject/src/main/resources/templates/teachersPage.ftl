                ...
                <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="/addTeacher"  method="post"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="x_content">
                                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                                        ...
                                        <tr>
                                            ...
                                            <td>Abramskiy Michael</td>
                                            <td>Male</td>
                                            <td>01.01.1989</td>
                                            <td>abramsliy@gmail.com</td>
                                            <td>9655555500</td>
                                        </tr>
                                        </tbody>
                                    </table>
